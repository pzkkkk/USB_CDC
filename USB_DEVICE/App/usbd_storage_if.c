...
//	  W25QXX_Read(buf,blk_addr * STORAGE_BLK_SIZ,blk_len*STORAGE_BLK_SIZ );///////ok!
	}
	  return (USBD_OK);
  /* USER CODE END 6 */
}
...
//	  W25QXX_Erase_Sector(blk_addr + i);
	  W25QXX_Write((uint8_t *)(buf + i * STORAGE_BLK_SIZ),blk_addr * STORAGE_BLK_SIZ + i * STORAGE_BLK_SIZ,STORAGE_BLK_SIZ );
//	  W25QXX_Write(buf,blk_addr * STORAGE_BLK_SIZ,blk_len*STORAGE_BLK_SIZ );  /////////ok!
